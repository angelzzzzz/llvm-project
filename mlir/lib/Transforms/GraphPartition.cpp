...
public:
  ...
  void calculateTimingCost(Block *block) {
  unsigned timingCost = 0;
  unsigned freeCycle = std::move(freeCycleCost);
  unsigned basicCycle = std::move(basicCycleCost);
  unsigned expensiveCycle = std::move(expensiveCycleCost);
  block->walk([&](Operation *op) {
    unsigned operationCost = TypeSwitch<Operation *, unsigned>(op)
    ...
    .Case([&](LLVM::AtomicCmpXchgOp op){return basicCycle;})
    .Case([&](LLVM::AtomicRMWOp op){return basicCycle;})
    .Case([&](LLVM::BitcastOp op){return basicCycle;})
    .Case([&](LLVM::BrOp op){return basicCycle;})
    .Case([&](LLVM::CallIntrinsicOp op){return basicCycle;})
    .Case([&](LLVM::CallOp op){return basicCycle;})
    .Case([&](LLVM::ComdatOp op){return basicCycle;})
    .Case([&](LLVM::ComdatSelectorOp op){return basicCycle;})
    ...
    .Case([&](LLVM::FDivOp op){return basicCycle;})
    ...
    .Case([&](LLVM::FreezeOp op){return basicCycle;})
    .Case([&](LLVM::GEPOp op){return basicCycle;})
    .Case([&](LLVM::GlobalCtorsOp op){return basicCycle;})
    .Case([&](LLVM::GlobalDtorsOp op){return basicCycle;})
    .Case([&](LLVM::GlobalOp op){return basicCycle;})
    .Case([&](LLVM::ICmpOp op){return basicCycle;})
    .Case([&](LLVM::InlineAsmOp op){return basicCycle;})
    ...
    .Case([&](LLVM::InvokeOp op){return basicCycle;})
    .Case([&](LLVM::LLVMFuncOp op){return basicCycle;})
    .Case([&](LLVM::LShrOp op){return basicCycle;})
    .Case([&](LLVM::LandingpadOp op){return basicCycle;})
    .Case([&](LLVM::LinkerOptionsOp op){return basicCycle;})
    .Case([&](LLVM::LoadOp op){return basicCycle;})
    .Case([&](LLVM::MulOp op){return basicCycle;})
    .Case([&](LLVM::NoneTokenOp op){return basicCycle;})
    .Case([&](LLVM::OrOp op){return basicCycle;})
    .Case([&](LLVM::PoisonOp op){return basicCycle;})
    .Case([&](LLVM::PtrToIntOp op){return basicCycle;})
    .Case([&](LLVM::ResumeOp op){return basicCycle;})
    .Case([&](LLVM::ReturnOp op){return basicCycle;})
    .Case([&](LLVM::SDivOp op){return basicCycle;})
    .Case([&](LLVM::SExtOp op){return basicCycle;})
    .Case([&](LLVM::SIToFPOp op){return basicCycle;})
    .Case([&](LLVM::SRemOp op){return basicCycle;})
    ...
    .Case([&](LLVM::CoroResumeOp op){return basicCycle;})
    .Case([&](LLVM::CoroSaveOp op){return basicCycle;})
    .Case([&](LLVM::CoroSizeOp op){return basicCycle;})
    .Case([&](LLVM::CoroSuspendOp op){return basicCycle;})
    ...
    .Case([&](LLVM::Exp2Op op){return basicCycle;})
    .Case([&](LLVM::ExpOp op){return basicCycle;})
    ...
    .Case([&](LLVM::LlrintOp op){return basicCycle;})
    .Case([&](LLVM::LlroundOp op){return basicCycle;})
    .Case([&](LLVM::Log10Op op){return basicCycle;})
    .Case([&](LLVM::Log2Op op){return basicCycle;})
    .Case([&](LLVM::LogOp op){return basicCycle;})
    .Case([&](LLVM::LrintOp op){return basicCycle;})
    .Case([&](LLVM::LroundOp op){return basicCycle;})
    .Case([&](LLVM::MaskedLoadOp op){return basicCycle;})
    .Case([&](LLVM::MaskedStoreOp op){return basicCycle;})
    .Case([&](LLVM::MatrixColumnMajorLoadOp op){return basicCycle;})
    .Case([&](LLVM::MatrixColumnMajorStoreOp op){return basicCycle;})
    .Case([&](LLVM::MatrixMultiplyOp op){return basicCycle;})
    ...
    .Case([&](LLVM::MemcpyOp op){return basicCycle;})
    .Case([&](LLVM::MemmoveOp op){return basicCycle;})
    ...
    .Case([&](LLVM::PowIOp op){return basicCycle;})
    .Case([&](LLVM::PowOp op){return basicCycle;})
    .Case([&](LLVM::PtrAnnotation op){return basicCycle;})
    .Case([&](LLVM::RintOp op){return basicCycle;})
    .Case([&](LLVM::RoundEvenOp op){return basicCycle;})
    .Case([&](LLVM::RoundOp op){return basicCycle;})
    ...
    .Case([&](LLVM::SMulWithOverflowOp op){return basicCycle;})
    .Case([&](LLVM::SSACopyOp op){return basicCycle;})
    .Case([&](LLVM::SSHLSat op){return basicCycle;})
    .Case([&](LLVM::SSubSat op){return basicCycle;})
    .Case([&](LLVM::SSubWithOverflowOp op){return basicCycle;})
    .Case([&](LLVM::SinOp op){return basicCycle;})
    .Case([&](LLVM::SqrtOp op){return basicCycle;})
    ...
    .Case([&](LLVM::ThreadlocalAddressOp op){return basicCycle;})
    .Case([&](LLVM::UAddWithOverflowOp op){return basicCycle;})
    .Case([&](LLVM::UBSanTrap op){return basicCycle;})
    .Case([&](LLVM::UMaxOp op){return basicCycle;})
    .Case([&](LLVM::UMinOp op){return basicCycle;})
    .Case([&](LLVM::UMulWithOverflowOp op){return basicCycle;})
    .Case([&](LLVM::USHLSat op){return basicCycle;})
    .Case([&](LLVM::USubSat op){return basicCycle;})
    .Case([&](LLVM::USubWithOverflowOp op){return basicCycle;})
    .Case([&](LLVM::VPAShrOp op){return basicCycle;})
    .Case([&](LLVM::VPAddOp op){return basicCycle;})
    .Case([&](LLVM::VPAndOp op){return basicCycle;})
    .Case([&](LLVM::VPFAddOp op){return basicCycle;})
    .Case([&](LLVM::VPFDivOp op){return basicCycle;})
    .Case([&](LLVM::VPFMulAddOp op){return basicCycle;})
    .Case([&](LLVM::VPFMulOp op){return basicCycle;})
    .Case([&](LLVM::VPFNegOp op){return basicCycle;})
    .Case([&](LLVM::VPFPExtOp op){return basicCycle;})
    .Case([&](LLVM::VPFPToSIOp op){return basicCycle;})
    .Case([&](LLVM::VPFPToUIOp op){return basicCycle;})
    .Case([&](LLVM::VPFPTruncOp op){return basicCycle;})
    .Case([&](LLVM::VPFRemOp op){return basicCycle;})
    .Case([&](LLVM::VPFSubOp op){return basicCycle;})
    .Case([&](LLVM::VPFmaOp op){return basicCycle;})
    ...
    .Case([&](LLVM::VPMergeMinOp op){return basicCycle;})
    .Case([&](LLVM::VPMulOp op){return basicCycle;})
    .Case([&](LLVM::VPOrOp op){return basicCycle;})
    .Case([&](LLVM::VPPtrToIntOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceAddOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceAndOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceFAddOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceFMaxOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceFMinOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceFMulOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceMulOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceOrOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceSMaxOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceSMinOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceUMaxOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceUMinOp op){return basicCycle;})
    .Case([&](LLVM::VPReduceXorOp op){return basicCycle;})
    .Case([&](LLVM::VPSDivOp op){return basicCycle;})
    .Case([&](LLVM::VPSExtOp op){return basicCycle;})
    .Case([&](LLVM::VPSIToFPOp op){return basicCycle;})
    ...
    .Case([&](LLVM::VPURemOp op){return basicCycle;})
    ...
    .Case([&](LLVM::masked_compressstore op){return basicCycle;})
    .Case([&](LLVM::masked_expandload op){return basicCycle;})
    .Case([&](LLVM::masked_gather op){return basicCycle;})
    .Case([&](LLVM::masked_scatter op){return basicCycle;})
    .Case([&](LLVM::vector_extract op){return basicCycle;})
    .Case([&](LLVM::vector_insert op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_add op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_and op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_fadd op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_fmax op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_fmaximum op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_fmin op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_fminimum op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_mul op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_or op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_smax op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_smin op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_umax op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_umin op){return basicCycle;})
    .Case([&](LLVM::vector_reduce_xor op){return basicCycle;})
    .Case([&](LLVM::vscale op){return basicCycle;})
    ;
