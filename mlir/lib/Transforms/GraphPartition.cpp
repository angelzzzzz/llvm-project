    ...
    block->walk([&](Operation *op) {
      unsigned operationCost =
          TypeSwitch<Operation *, unsigned>(op)
              ...
              .Case(
                  [&](LLVM::ThreadlocalAddressOp op) { return expensiveCycle; })
              ...
              .Case(
                  [&](LLVM::masked_compressstore op) { return expensiveCycle; })
              ...
              .Case([&](LLVM::vector_reduce_fmaximum op) {
                return expensiveCycle;
              })
              .Case([&](LLVM::vector_reduce_fmin op) { return expensiveCycle; })
              .Case([&](LLVM::vector_reduce_fminimum op) {
                return expensiveCycle;
              })
